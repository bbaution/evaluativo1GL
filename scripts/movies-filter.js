...
// 👇cargamos el select con los nombres de usuarios
users.forEach(e => {
...
const filterMovies = ({ users, movies, userId, fromDate, toDate, rate }) => {
    ...
    //👇 Filtro final
    // Se utiliza map, para crear un nuevo objeto que contiene todos los datos de las peliculas y usuarios asociados
    // find para localizar que pelicula vio cada usuario, de manera indivual y lo vamos acumulando en un objeto
...
//👇jquery boton para volver al inicio  de la pag
const showOnPx = 100;
...
//👇 lo muestra cuando scrolleamos mas de 100px
...
//👇 Nos lleva al comienzo de la pag
const goToTop = () => {
...
// users.filter(userPrueba=>{
//     let pruebaObj = obj;
//     movies.filter(moviePrueba=>{
//         if(userPrueba.id === moviePrueba.userId){
//             return obj.push({
//                 id: userPrueba.id,
//                 userName: userPrueba.username,
//                 email: userPrueba.email,
//                 fullAddres: `${userPrueba.address.street} - ${userPrueba.address.city}`,
//                 movie: moviePrueba.title,
//                 rate: moviePrueba.rate
//             })
//         }
//     })
// })
